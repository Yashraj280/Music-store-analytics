...
3. Import csv files provided in the datasets.
...
The following are a few of the questions that are answered in the project (check out analysis.sql</a> file for the rest):
